...
| 01 | `01_wgcna.ipynb` | Week 2 | Per-tissue co-expression networks via PyWGCNA. Two parallel pipelines (shoot, root) using your committed network-construction parameters. | `shoot.p`, `root.p` (PyWGCNA pickles) |
