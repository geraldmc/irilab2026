...
Notebook scaffolding drafted; body section content still to fill. Four notebooks numbered 00–03, opener-plus-preamble base in place, body section headers numbered. NB01 accuracy-gate framing (hard "stop here if not" vs soft "note what this means for your interpretation") is an open question carried forward to body-content drafting.